...
from keras.layers import Activation, Conv2D, Input, MaxPooling2D, concatenate
...
class BaseFeatureExtractor(ABC):
    ...
    def __init__(self, input_size, weight_file):
        self.input_size = input_size
        self.weight_file = weight_file
        self.feature_extractor = self._build_model()
    ...
    def load_weights(self):
        self.feature_extractor.load_weights(self)
